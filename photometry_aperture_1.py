...
plt.imshow(image_data, vmin=-1, vmax=1, origin='lower')
plt.show()

# Display the F606W POL_0 image
plt.imshow(img_0, vmin=-1, vmax=1, origin='lower')
plt.show()
...
print(f'polarization = {pol_frac:0.2%}, Position Angle = {pol_data.angle}')
