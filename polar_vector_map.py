...
overlay[0].set_axislabel('R.A. (J2000)')
...
# Draw a horizontal line as the reference distance
x_start, x_end = 2046, 2062
i_plot.plot([x_start, x_end], [50, 50], 'w-', lw=3)  # Red line at y=0

# Add label above the line
i_plot.text((x_start + x_end) / 2, 100, r'$50\%$', fontsize=18, color='white', ha='center')
