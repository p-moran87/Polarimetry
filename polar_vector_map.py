...
i_plot.set_xlabel('Galactic Longitude')
i_plot.set_ylabel('Galactic Latitude')
...
# Define circle properties (center (x, y) and radius)
circle = plt.Circle((1117, 822), 30, color='red', 
                    fill=False, linewidth=1.5)

i_plot.add_patch(circle)
